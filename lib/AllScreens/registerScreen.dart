...
import 'package:helocar/AllScreens/loggedInScreen.dart';
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Nama Anda Sesui KTPe',
                            hintStyle:
                            TextStyle(color: Colors.grey, fontStyle: FontStyle.italic),
                          ),
                          validator: (value) {
                            if (value.isEmpty) {
                              return 'Silahkan Lengkapi Nama';
                            }
                            return null;
                          },
                        ),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: '81242780XXX',
                            hintStyle:
                            TextStyle(color: Colors.grey, fontStyle: FontStyle.italic),
                          ),
                          validator: (value) {
                            if (value.isEmpty) {
                              return 'Silahkan masukan No. Telepon';
                            }
                            return null;
                          },
                        ),
                ...
                !isLoading
                    ? Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value.isEmpty) {
                              return 'Masukkan kode OTP dari SMS';
                            }
                            return null;
                          },
                        ),
              ...
              if (user != null)
                {
                  ...
                  await _firestore
                      ...
                      .set({
                        ...
                        'phone': '+62${cellNumberController.text.trim()}'
