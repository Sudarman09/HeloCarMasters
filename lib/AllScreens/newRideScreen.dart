...
import 'package:helocar/AllWidgets/CollectFareDialog.dart';
import 'package:helocar/AllWidgets/progressDialog.dart';
import 'package:helocar/Assistants/assistantMethods.dart';
import 'package:helocar/Assistants/mapKitAssistant.dart';
...
class _NewRideScreenState extends State<NewRideScreen> {
  ...
  String btnTitle = "Bertemu Jemputan? Iya";
  ...
  void getRideLiveLocationUpdate() {
    ...
    rideStreamSubscription =
      ...
      var rot = MapKitAssistant.getMarkerRotation(oldPos.latitude,
          oldPos.longitude, myPosition.longitude, myPosition.longitude);
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      'sekitar ' + durationRide + ' ke tujuan',
                      style: TextStyle(
                          fontSize: 14.0,
  ...
  Future<void> getPlaceDirection(
    ...
    // print("Ini Jalur jalur Yaaaaaaaaaaaaaa ::");
